...
linea = cv2.line(imagen, (int(1070/2),int(194/2)), (int(1152/2),int(461/2)), (0,0,255), thickness = 5, lineType = cv2.LINE_AA)

# Circulo
# img = cv2.circle(img, pt1(x,y), radio, color, grosorlinea(thickness), tipolinea(lineType))
circulo = cv2.circle(imagen, (int(1080/2),int(185/2)), 70, (255,0,0), thickness = 1, lineType = cv2.LINE_AA)

# Rectangulo
# img = cv2.rectangle(img, pt1(x,y), pt2, color,grosorlinea(thickness),tipolinea(lineType))
rectangulo = cv2.rectangle(imagen, (int(1000/2),int(400/2)), (int(1400/2),int(500/2)), (0,255,0), thickness = 3, lineType = cv2.LINE_AA)
